...
describe("Day 4", () => {
	...
	describe("Part 2", () => {
		it("should return 0 when given invalid passports", () => {
			assert.strictEqual(part2(invalidPassports), 0);
		});
		it("should return 4 when given valid passports", () => {
			assert.strictEqual(part2(validPassports), 4);
		});
	});
});